...
public class CRC16M {
    ...
    public static void main(String[] args) {
        ...
        byte[] sbuf0 = CRC16M.getSendBuf("0105");
        System.out.println(CRC16M.getBufHexStr(sbuf0));
        byte[] sbuf1 = CRC16M.getSendBuf("010f01");
        System.out.println(CRC16M.getBufHexStr(sbuf1));
        byte[] sbuf2 = CRC16M.getSendBuf("010f02");
        System.out.println(CRC16M.getBufHexStr(sbuf2));
        byte[] sbuf3 = CRC16M.getSendBuf("010f03");
        System.out.println(CRC16M.getBufHexStr(sbuf3));
        byte[] sbuf4 = CRC16M.getSendBuf("0105");
        System.out.println(CRC16M.getBufHexStr(sbuf4));

        //String s = CRC16M.getBufHexStr(sbuf1);
